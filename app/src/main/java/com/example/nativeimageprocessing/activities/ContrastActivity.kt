...
import com.example.nativeimageprocessing.databinding.ActivityContrastBinding
import java.io.File
...
class ContrastActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityContrastBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityContrastBinding.inflate(layoutInflater)
        ...
        binding.seekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                ...
                val contrastValue = (progress - 100) * 255 / 100 // Maps 0–200 to -255 to +255
